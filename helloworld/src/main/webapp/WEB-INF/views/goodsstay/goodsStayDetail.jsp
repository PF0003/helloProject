	...
	<table style="min-width:1000px;">
		<tr>
			<td rowspan="11" width="50%">
				<div id="슬라이드 집어 넣을 곳">
					<img src="${contextPath }/resources/image/hotel.png" alt="사지인" style="width:450px;height:450px;">
				</div>
			</td>
		<tr>
			<td>숙박업소명</td>
		...
		<tr>
			<td>주소</td>
			<td>${goods.goods_stay_roadAddress }</td>
			<td><input type="button" value="지도보기" onClick="" /></td>
		</tr>
		<tr>
			<td>방 수량</td>
			<td>
...
<div style="overflow:scroll; width:auto; height:150px;" >
	<div>
		<h4>홈 > 커뮤니티 > 리뷰</h4>
