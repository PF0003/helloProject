	...
	<tr>
		<c:choose>
				...
				<c:when test="${isLogOn==true and not empty businessInfo}">
					...
					<td id="btn_d" style="height: 30px">
						<button type="button" class="subm" onclick="let busi_id = '${sessionScope.businessInfo.busi_id}'; location.href='http://localhost:8080/helloworld/business/listAll.do?busi_id=' + busi_id;" style="width: 120px;">상품관리<img src="${contextPath}/resources/image/cart1.png" id="cartImg" /></button>
					</td>
				</c:when>
				<c:otherwise>
...
<nav class="navbar">
  <ul class="nav">
    ...
    <li class="headerLi">
      ...
      <ul class="dropdown">
      	<li class="ddli"><a href="${contextPath}/searchGoodsStay.do" class="ddli">지역별</a></li>
      	<li class="ddli">종류별</li>
      	<li class="ddli">금액별</li>
      </ul>
    </li>
    <li class="headerLi">
      <a href="#" class="headerA">상품추천</a>
      <ul class="dropdown">
