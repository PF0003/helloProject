...
<!--카카오 회원탈퇴-->
  <c:if test="${not empty userId and not empty access_Token}">
  <article class="fifth">
  ...
  <!--회원탈퇴-->
  <c:if test="${not empty memberInfo.mem_id and empty userId}">
  <article class="fifth">
  ...
  <!--사업자탈퇴-->
  <c:if test="${not empty businessInfo.busi_id and empty userId}">
  <article class="fifth">
